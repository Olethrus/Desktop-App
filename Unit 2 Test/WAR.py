...
class PlayerClass:
	"""This is the player class it will have a play and recieve card function to pass the pot to the winner"""
	...
	def recieve_card(self,game_cards):
		"""This will update a players deck and recieve cards in the form of a single card or a list"""
...
if __name__ == "__main__":
	...
	for i in range(i_draw):
		player_1.recieve_card(fulldeck.deal()) 
		player_2.recieve_card(fulldeck.deal())
	while game_result == "True":
		...
		if (round_result[0] == 1):
			player_1.recieve_card(card_pot)
		elif (round_result[0] == 2):
			player_2.recieve_card(card_pot)
